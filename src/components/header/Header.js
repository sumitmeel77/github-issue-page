...
const navigationValues = [
  ...
  {
    name: 'Issues', selected: true, url: `${window.location.origin}`,
  },
  {
    name: 'Pull Requests', selected: false, url: `${WEB_URL}/${OWNER}/${REPO}/pulls`,
  },
  {
    name: 'Discussions', selected: false, url: `${WEB_URL}/${OWNER}/${REPO}/discussions`,
  },
  {
    name: 'Actions', selected: false, url: `${WEB_URL}/${OWNER}/${REPO}/actions`,
  },
  {
